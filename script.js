...
function getDeliveryCharge() {
    ...
    /*
       HIDDEN YOUTH DELIVERY ZONES
       BASE: BATAPUR / HARBANS PURA
    ...
    */
    ...
    /*
       Any other valid 5-digit Lahore code gets
       the FAR delivery charge instead of Rs. 0.
    */
    return 500;
}
    ...
    postalCodeInput.addEventListener(
        ...
        function () {
            ...
            if (area) {
                ...
                /*
                   Unknown Lahore code:
                   show Lahore and use Rs. 500 FAR delivery.
                */
